interface CaffeineUnit {
  ...
  GetComboPoints(unit: CaffeineUnit | null): number;
  ...
  GetMaxGCD(): number;
  GetMaxHealth(): number;
  GetMaxPower(powerType: number | null): number;
  ...
  GetPower(powerType: number | null): number;
  GetPowerDeficit(powerType: number | null): number;
  GetPowerRegen(): number;
  GetPowerType(): number;
  GetPP(powerType: number | null): number;
  GetRawUnit(): string;
